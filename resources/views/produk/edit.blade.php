...
<head>
    ...
    <title>Edit Produk - MyBelanjaMu</title>
            ...
            <div class="flex justify-between items-center h-16">
                <div class="flex items-center gap-2">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-purple-200">Edit Produk</p>
                    </div>
                </div>
            ...
            <form method="POST" action="{{ route('produk.update', $produk->id) }}" enctype="multipart/form-data">
                ...
                <div class="mb-6">
                    ...
                    <textarea name="deskripsi" id="deskripsi" rows="4"
                              ...
                              placeholder="Jelaskan detail produk Anda">{{ old('deskripsi', $produk->deskripsi) }}</textarea>
                    @error('deskripsi')
                        <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="mb-6">
                    ...
                    <p class="mt-1 text-xs text-gray-500">Format: JPG, PNG, GIF. Maksimal 2MB. Kosongkan jika tidak ingin mengganti gambar.</p>
                    @error('gambar')
                        <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="mb-6">
                    ...
                    <input type="text" name="nomor_whatsapp" id="nomor_whatsapp" value="{{ old('nomor_whatsapp', $produk->nomor_whatsapp) }}" required
                ...
                <div class="mb-6">
                    <label class="flex items-center">
                        <input type="checkbox" name="status" value="1" {{ old('status', $produk->status) ? 'checked' : '' }}
