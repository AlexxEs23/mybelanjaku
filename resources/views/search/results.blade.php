...
<head>
    ...
    <title>Hasil Pencarian: {{ $query }} - CheckoutAja</title>
...
<body class="bg-gray-50 min-h-screen">
            ...
            <div class="flex justify-between items-center py-3 sm:py-4">
                ...
                <div class="hidden sm:flex items-center gap-4">
                    @guest
                        ...
                        <a href="{{ url('/register') }}" class="px-4 py-2 bg-purple-600 hover:bg-purple-700 text-white rounded-lg hover:shadow-lg transition font-medium">
                            Daftar
                        </a>
                    @else
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 mb-8">
                ...
                <div class="bg-white border border-gray-200 rounded-xl hover:shadow-xl transition overflow-hidden group">
                    <a href="{{ route('produk.detail', $product->slug ?? $product->id) }}" class="block">
                        <div class="relative">
                            <div class="aspect-square bg-purple-100 flex items-center justify-center overflow-hidden">
                                @if($product->gambar)
                    ...
                    <div class="px-3 pb-3">
                        @if($product->stok > 0 && $product->status)
                            <a href="{{ route('whatsapp.checkout.show', $product->id) }}" 
                               class="group relative overflow-hidden block w-full px-4 py-3 bg-green-600 hover:bg-green-700 text-white text-center text-sm font-bold rounded-xl transition-all duration-300 transform hover:scale-105 hover:shadow-lg active:scale-95">
    ...
    <!-- Footer -->
    <footer class="bg-purple-800 text-white mt-16">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <div class="flex gap-4">
                        <a href="https://www.instagram.com/checkoutaja" target="_blank" rel="noopener noreferrer" class="w-10 h-10 bg-purple-700 rounded-full flex items-center justify-center hover:bg-purple-600 transition">
