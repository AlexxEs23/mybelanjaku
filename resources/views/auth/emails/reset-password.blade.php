...
<head>
    ...
    <title>Reset Password - CheckoutAja.com</title>
    <style>
        body {
...
<body>
    <div class="email-container">
        ...
        <div class="email-body">
            ...
            <p>Kami menerima permintaan untuk mereset password akun Anda di <strong>CheckoutAja.com</strong>.</p>
